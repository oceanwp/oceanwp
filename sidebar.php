...
<aside id="right-sidebar" class="sidebar-container widget-area sidebar-primary"<?php oceanwp_schema_attr( 'sidebar' ); ?> role="complementary" aria-label="<?php esc_attr_e( 'Primary Sidebar', 'oceanwp' ); ?>">
