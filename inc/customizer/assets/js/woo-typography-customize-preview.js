...
(function ($) {
  ...
  api("woo_product_title_typography[font-family]", function ($swipe) {
    $swipe.bind(function (pair) {
      if (pair) {
        ...
        var idfirst =
          ...
          "customizer-typography-product-title-font-family");
    ...
    api("woo_product_title_tablet_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_product_title-tablet-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_product_title_mobile_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_product_title-mobile-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_product_title_tablet_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_product_title-tablet-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_product_title_mobile_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_product_title-mobile-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api(
      "woo_product_title_tablet_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_product_title-tablet-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_product_title_mobile_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_product_title-mobile-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api("woo_product_price_typography[font-family]", function ($swipe) {
      $swipe.bind(function (pair) {
        if (pair) {
          ...
          var idfirst =
            (pair.trim().toLowerCase().replace(" ", "-"),
            "customizer-typography-product-price-font-family");
          var fontSize = pair.replace(" ", "%20");
          fontSize = fontSize.replace(",", "%2C");
          /** @type {string} */
          fontSize =
    ...
    api("woo_product_price_tablet_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-product-price-tablet-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_product_price_mobile_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-product-price-mobile-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api(
      "woo_product_price_tablet_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-product-price-tablet-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_product_price_mobile_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-product-price-mobile-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api("woo_product_add_to_cart_typography[font-family]", function ($swipe) {
      $swipe.bind(function (pair) {
        if (pair) {
          ...
          var idfirst =
            (pair.trim().toLowerCase().replace(" ", "-"),
            "customizer-typography-add-to-cart-font-family");
          var fontSize = pair.replace(" ", "%20");
          fontSize = fontSize.replace(",", "%2C");
          /** @type {string} */
          fontSize =
    ...
    api(
      "woo_product_add_to_cart_tablet_typography[font-size]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_product_add_to_cart-tablet-font-size"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_product_add_to_cart_mobile_typography[font-size]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_product_add_to_cart-mobile-font-size"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_product_add_to_cart_tablet_typography[line-height]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_product_add_to_cart-tablet-line-height"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_product_add_to_cart_mobile_typography[line-height]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_product_add_to_cart-mobile-line-height"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_product_add_to_cart_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
    ...
    api(
      "woo_product_add_to_cart_tablet_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_product_add_to_cart-tablet-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_product_add_to_cart_mobile_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_product_add_to_cart-mobile-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_product_add_to_cart_typography[text-transform]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
    ...
    api("woo_single_notice_typography[font-family]", function ($swipe) {
      $swipe.bind(function (pair) {
        if (pair) {
          ...
          var idfirst =
            (pair.trim().toLowerCase().replace(" ", "-"),
            "customizer-typography-single-notice-font-family");
          var fontSize = pair.replace(" ", "%20");
          fontSize = fontSize.replace(",", "%2C");
          /** @type {string} */
          fontSize =
    ...
    api("woo_single_notice_tablet_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_single_notice-tablet-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_single_notice_mobile_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_single_notice-mobile-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_single_notice_tablet_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_single_notice-tablet-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_single_notice_mobile_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_single_notice-mobile-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api(
      "woo_single_notice_tablet_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_single_notice-tablet-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_single_notice_mobile_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_single_notice-mobile-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api("woo_archive_title_typography[font-family]", function ($swipe) {
      $swipe.bind(function (pair) {
        if (pair) {
          ...
          var idfirst =
            (pair.trim().toLowerCase().replace(" ", "-"),
            "customizer-typography-archive-title-font-family");
          var fontSize = pair.replace(" ", "%20");
          fontSize = fontSize.replace(",", "%2C");
          /** @type {string} */
          fontSize =
    ...
    api("woo_archive_title_tablet_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_title-tablet-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_title_mobile_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_title-mobile-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_title_tablet_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_title-tablet-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_title_mobile_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_title-mobile-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_title_typography[letter-spacing]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo-archive-title-letter-spacing"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api(
      "woo_archive_title_tablet_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_archive_title-tablet-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_archive_title_mobile_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_archive_title-mobile-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api("woo_archive_title_typography[text-transform]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo-archive-title-text-transform"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_cats_typography[font-family]", function ($swipe) {
      $swipe.bind(function (pair) {
        if (pair) {
          ...
          var idfirst =
            (pair.trim().toLowerCase().replace(" ", "-"),
            "customizer-typography-archive-category-font-family");
          var fontSize = pair.replace(" ", "%20");
          fontSize = fontSize.replace(",", "%2C");
          /** @type {string} */
          fontSize =
    ...
    api("woo_archive_cats_typography[font-weight]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo-archive-category-font-weight"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_cats_typography[font-style]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo-archive-category-font-style"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_cats_tablet_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_category-tablet-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_cats_mobile_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_category-mobile-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_cats_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo-archive-category-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_cats_tablet_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_category-tablet-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_cats_mobile_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_category-mobile-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_cats_typography[letter-spacing]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo-archive-category-letter-spacing"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api(
      "woo_archive_cats_tablet_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_archive_category-tablet-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_archive_cats_mobile_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_archive_category-mobile-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api("woo_archive_cats_typography[text-transform]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo-archive-category-text-transform"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_price_typography[font-family]", function ($swipe) {
      $swipe.bind(function (pair) {
        if (pair) {
          ...
          var idfirst =
            (pair.trim().toLowerCase().replace(" ", "-"),
            "customizer-typography-archive-price-font-family");
          var fontSize = pair.replace(" ", "%20");
          fontSize = fontSize.replace(",", "%2C");
          /** @type {string} */
          fontSize =
    ...
    api("woo_archive_price_tablet_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_price-tablet-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_price_mobile_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_price-mobile-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_price_tablet_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_price-tablet-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_price_mobile_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_price-mobile-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_price_typography[letter-spacing]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo-archive-price-letter-spacing"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api(
      "woo_archive_price_tablet_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_archive_price-tablet-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_archive_price_mobile_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_archive_price-mobile-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api("woo_archive_price_typography[text-transform]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo-archive-price-text-transform"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api(
      "woo_single_add_to_cart_tablet_typography[font-size]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_single_add_to_cart-tablet-font-size"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_single_add_to_cart_mobile_typography[font-size]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_single_add_to_cart-mobile-font-size"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_single_add_to_cart_tablet_typography[line-height]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_single_add_to_cart-tablet-line-height"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_single_add_to_cart_mobile_typography[line-height]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_single_add_to_cart-mobile-line-height"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api("woo_single_add_to_cart_typography[letter-spacing]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-single-add-to-cart-letter-spacing"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api(
      "woo_single_add_to_cart_tablet_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_single_add_to_cart-tablet-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_single_add_to_cart_mobile_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_single_add_to_cart-mobile-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api("woo_single_add_to_cart_typography[text-transform]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-single-add-to-cart-text-transform"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_notice_typography[font-family]", function ($swipe) {
      $swipe.bind(function (pair) {
        if (pair) {
          ...
          var idfirst =
            (pair.trim().toLowerCase().replace(" ", "-"),
            "customizer-typography-archive-notice-font-family");
          var fontSize = pair.replace(" ", "%20");
          fontSize = fontSize.replace(",", "%2C");
          /** @type {string} */
          fontSize =
    ...
    api("woo_archive_notice_tablet_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_notice-tablet-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_notice_mobile_typography[font-size]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_notice-mobile-font-size"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_notice_tablet_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_notice-tablet-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api("woo_archive_notice_mobile_typography[line-height]", function ($swipe) {
      $swipe.bind(function (dataAndEvents) {
        var $child = $(
          ".customizer-typography-woo_archive_notice-mobile-line-height"
        );
        if (dataAndEvents) {
          /** @type {string} */
          var img =
    ...
    api(
      "woo_archive_notice_tablet_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_archive_notice-tablet-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
    ...
    api(
      "woo_archive_notice_mobile_typography[letter-spacing]",
      function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
          var $child = $(
            ".customizer-typography-woo_archive_notice-mobile-letter-spacing"
          );
          if (dataAndEvents) {
            /** @type {string} */
            var img =
