...
if ( ! class_exists( 'OceanWP_Typography_Customizer' ) ) :
	...
	class OceanWP_Typography_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			$wp_customize->add_control(
				new OceanWP_Customize_Multicheck_Control(
					$wp_customize,
					'ocean_google_font_subsets',
					array(
			...
			foreach ( $elements as $element => $array ) {
				...
				if ( $label ) {
					...
					if ( in_array( 'font-size', $attributes ) ) {
						...
						$wp_customize->add_control(
							new OceanWP_Customizer_Text_Control(
								$wp_customize,
								$element . '_typography[font-size]',
								array(
