...
if ( ! class_exists( 'OceanWP_EDD_Customizer' ) ) :
	...
	class OceanWP_EDD_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_cat_widget_style', array(
				'transport'           	=> 'postMessage',
				'default'           	=> 'default',
				'sanitize_callback' 	=> 'oceanwp_sanitize_select',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ocean_edd_cat_widget_style', array(
				'label'	   				=> esc_html__( 'Categories Widget Style', 'oceanwp' ),
				'description'	   		=> esc_html__( 'Choose the EDD Categories widget style.', 'oceanwp' ),
				'type' 					=> 'select',
				'section'  				=> 'ocean_edd_general',
				'settings' 				=> 'ocean_edd_cat_widget_style',
				'priority' 				=> 10,
				'choices' 				=> array(
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_sale_badge_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Heading_Control( $wp_customize, 'ocean_edd_sale_badge_heading', array(
			 ...
			 * On Sale Badge Style
			 */
			$wp_customize->add_setting( 'ocean_edd_sale_badge_style', array(
				'transport'           	=> 'postMessage',
				'default'           	=> 'square',
				'sanitize_callback' 	=> 'oceanwp_sanitize_select',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ocean_edd_sale_badge_style', array(
				'label'	   				=> esc_html__( 'On Sale Badge Style', 'oceanwp' ),
				'type' 					=> 'select',
				'section'  				=> 'ocean_edd_general',
				'settings' 				=> 'ocean_edd_sale_badge_style',
				'priority' 				=> 10,
				'choices' 				=> array(
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_sale_badge_content', array(
				'default'           	=> 'sale',
				'sanitize_callback' 	=> 'oceanwp_sanitize_select',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ocean_edd_sale_badge_content', array(
				'label'	   				=> esc_html__( 'On Sale Badge Content', 'oceanwp' ),
				'type' 					=> 'select',
				'section'  				=> 'ocean_edd_general',
				'settings' 				=> 'ocean_edd_sale_badge_content',
				'priority' 				=> 10,
				'choices' 				=> array(
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_category_page_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Heading_Control( $wp_customize, 'ocean_edd_category_page_heading', array(
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_category_image', array(
				'default'           	=> 'no',
				'sanitize_callback' 	=> 'oceanwp_sanitize_select',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Buttonset_Control( $wp_customize, 'ocean_edd_category_image', array(
				...
				'section'  				=> 'ocean_edd_general',
				'settings' 				=> 'ocean_edd_category_image',
				'priority' 				=> 10,
				'choices' 				=> array(
					'yes' 	=> esc_html__( 'Yes', 'oceanwp' ),
					'no' 	=> esc_html__( 'No', 'oceanwp' ),
			 ...
			 * Link Color
			 */
			$wp_customize->add_setting( 'ocean_edd_cart_dropdown_link_color', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#333333',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_cart_dropdown_link_color', array(
				'label'	   				=> esc_html__( 'Link Color', 'oceanwp' ),
				'section'  				=> 'ocean_edd_menu_cart',
				'settings' 				=> 'ocean_edd_cart_dropdown_link_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Link Hover Color
			 */
			$wp_customize->add_setting( 'ocean_edd_cart_dropdown_link_color_hover', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#13aff0',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_cart_dropdown_link_color_hover', array(
				'label'	   				=> esc_html__( 'Link Color: Hover', 'oceanwp' ),
				'section'  				=> 'ocean_edd_menu_cart',
				'settings' 				=> 'ocean_edd_cart_dropdown_link_color_hover',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Quantity Color
			 */
			$wp_customize->add_setting( 'ocean_edd_cart_dropdown_quantity_color', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#b2b2b2',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_cart_dropdown_quantity_color', array(
				'label'	   				=> esc_html__( 'Quantity Color', 'oceanwp' ),
				'section'  				=> 'ocean_edd_menu_cart',
				'settings' 				=> 'ocean_edd_cart_dropdown_quantity_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Subtotal Color
			 */
			$wp_customize->add_setting( 'ocean_edd_cart_dropdown_subtotal_bg', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#fafafa',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_cart_dropdown_subtotal_bg', array(
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_cart_dropdown_cart_button_bg', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_cart_dropdown_cart_button_bg', array(
				'label'	   				=> esc_html__( 'Cart Button Background', 'oceanwp' ),
				'section'  				=> 'ocean_edd_menu_cart',
				'settings' 				=> 'ocean_edd_cart_dropdown_cart_button_bg',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_cart_dropdown_cart_button_hover_bg', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_cart_dropdown_cart_button_hover_bg', array(
				'label'	   				=> esc_html__( 'Cart Button Background: Hover', 'oceanwp' ),
				'section'  				=> 'ocean_edd_menu_cart',
				'settings' 				=> 'ocean_edd_cart_dropdown_cart_button_hover_bg',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Cart Button: Color
			 */
			$wp_customize->add_setting( 'ocean_edd_cart_dropdown_cart_button_color', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_cart_dropdown_cart_button_color', array(
				'label'	   				=> esc_html__( 'Cart Button Color', 'oceanwp' ),
				'section'  				=> 'ocean_edd_menu_cart',
				'settings' 				=> 'ocean_edd_cart_dropdown_cart_button_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_cart_dropdown_cart_button_hover_color', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_cart_dropdown_cart_button_hover_color', array(
				'label'	   				=> esc_html__( 'Cart Button Color: Hover', 'oceanwp' ),
				'section'  				=> 'ocean_edd_menu_cart',
				'settings' 				=> 'ocean_edd_cart_dropdown_cart_button_hover_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_cart_dropdown_cart_button_border_color', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_cart_dropdown_cart_button_border_color', array(
				'label'	   				=> esc_html__( 'Cart Button Border Color', 'oceanwp' ),
				'section'  				=> 'ocean_edd_menu_cart',
				'settings' 				=> 'ocean_edd_cart_dropdown_cart_button_border_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_cart_dropdown_cart_button_hover_border_color', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_cart_dropdown_cart_button_hover_border_color', array(
				'label'	   				=> esc_html__( 'Cart Button Border Color: Hover', 'oceanwp' ),
				'section'  				=> 'ocean_edd_menu_cart',
				'settings' 				=> 'ocean_edd_cart_dropdown_cart_button_hover_border_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Layout
			 */
			$wp_customize->add_setting( 'ocean_edd_shop_layout', array(
				'default'           	=> 'left-sidebar',
				'sanitize_callback' 	=> 'oceanwp_sanitize_select',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Radio_Image_Control( $wp_customize, 'ocean_edd_shop_layout', array(
				'label'	   				=> esc_html__( 'Layout', 'oceanwp' ),
				'section'  				=> 'ocean_edd_archives',
				'settings' 				=> 'ocean_edd_shop_layout',
				'priority' 				=> 10,
			 ...
			 * Both Sidebars Style
			 */
			$wp_customize->add_setting( 'ocean_edd_shop_both_sidebars_style', array(
				'default'           	=> 'scs-style',
				'sanitize_callback' 	=> 'oceanwp_sanitize_select',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ocean_edd_shop_both_sidebars_style', array(
				'label'	   				=> esc_html__( 'Both Sidebars: Style', 'oceanwp' ),
				'type' 					=> 'select',
				'section'  				=> 'ocean_edd_archives',
				'settings' 				=> 'ocean_edd_shop_both_sidebars_style',
				'priority' 				=> 10,
				'choices' 				=> array(
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_shop_both_sidebars_content_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_number_blank',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ocean_edd_shop_both_sidebars_content_width', array(
				'label'	   				=> esc_html__( 'Both Sidebars: Content Width (%)', 'oceanwp' ),
				'type' 					=> 'number',
				'section'  				=> 'ocean_edd_archives',
				'settings' 				=> 'ocean_edd_shop_both_sidebars_content_width',
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 0,
			        'max'   => 100,
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_shop_both_sidebars_sidebars_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_number_blank',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ocean_edd_shop_both_sidebars_sidebars_width', array(
				'label'	   				=> esc_html__( 'Both Sidebars: Sidebars Width (%)', 'oceanwp' ),
				'type' 					=> 'number',
				'section'  				=> 'ocean_edd_archives',
				'settings' 				=> 'ocean_edd_shop_both_sidebars_sidebars_width',
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 0,
			        'max'   => 100,
			 ...
			 * Shop Posts Per Page
			 */
			$wp_customize->add_setting( 'ocean_edd_shop_posts_per_page', array(
				'default'           	=> '12',
				'sanitize_callback' 	=> 'oceanwp_sanitize_number',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'ocean_edd_shop_posts_per_page', array(
				'label'	   				=> esc_html__( 'Shop Posts Per Page', 'oceanwp' ),
				'section'  				=> 'ocean_edd_archives',
				'settings' 				=> 'ocean_edd_shop_posts_per_page',
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 1,
			        'max'   => 100,
			 ...
			 * Shop Columns
			 */
			$wp_customize->add_setting( 'ocean_edd_shop_columns', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '3',
				'sanitize_callback' 	=> 'oceanwp_sanitize_number',
			) );
			...
			$wp_customize->add_control( new OceanWP_Customizer_Slider_Control( $wp_customize, 'ocean_edd_shop_columns', array(
				'label' 			=> esc_html__( 'Shop Columns', 'oceanwp' ),
				'section'  			=> 'ocean_edd_archives',
				'settings' => array(
		            'desktop' 	=> 'ocean_edd_shop_columns',
			 ...
			 * Toolbar Heading
			 */
			$wp_customize->add_setting( 'ocean_edd_shop_toolbar_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Heading_Control( $wp_customize, 'ocean_edd_shop_toolbar_heading', array(
			 ...
			 * Shop Sort
			 */
			$wp_customize->add_setting( 'ocean_edd_shop_sort', array(
				'default'           	=> true,
				'sanitize_callback' 	=> 'oceanwp_sanitize_checkbox',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ocean_edd_shop_sort', array(
				'label'	   				=> esc_html__( 'Shop Sort', 'oceanwp' ),
				'type' 					=> 'checkbox',
				'section'  				=> 'ocean_edd_archives',
				'settings' 				=> 'ocean_edd_shop_sort',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Shop Result Count
			 */
			$wp_customize->add_setting( 'ocean_edd_shop_result_count', array(
				'default'           	=> true,
				'sanitize_callback' 	=> 'oceanwp_sanitize_checkbox',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ocean_edd_shop_result_count', array(
				'label'	   				=> esc_html__( 'Shop Result Count', 'oceanwp' ),
				'type' 					=> 'checkbox',
				'section'  				=> 'ocean_edd_archives',
				'settings' 				=> 'ocean_edd_shop_result_count',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_shop_off_canvas_filter_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Heading_Control( $wp_customize, 'ocean_edd_shop_off_canvas_filter_heading', array(
			 ...
			 * Products Heading
			 */
			$wp_customize->add_setting( 'ocean_edd_shop_products_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Heading_Control( $wp_customize, 'ocean_edd_shop_products_heading', array(
			 ...
			 * Thumbnails Layout
			 */
			$wp_customize->add_setting( 'ocean_edd_product_thumbs_layout', array(
				'transport' 			=> 'postMessage',
				'default' 				=> 'horizontal',
				'sanitize_callback' 	=> 'sanitize_text_field',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ocean_edd_product_thumbs_layout', array(
				'label'	   				=> esc_html__( 'Thumbnails Layout', 'oceanwp' ),
				'type' 					=> 'select',
				'section'  				=> 'ocean_edd_single',
				'settings' 				=> 'ocean_edd_product_thumbs_layout',
				'priority' 				=> 10,
				'choices' 				=> array(
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_product_addtocart_style', array(
				'transport' 			=> 'postMessage',
				'default' 				=> 'normal',
				'sanitize_callback' 	=> 'sanitize_text_field',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ocean_edd_product_addtocart_style', array(
				'label'	   				=> esc_html__( 'Add To Cart Button Style', 'oceanwp' ),
				'type' 					=> 'select',
				'section'  				=> 'ocean_edd_single',
				'settings' 				=> 'ocean_edd_product_addtocart_style',
				'priority' 				=> 10,
				'choices' 				=> array(
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_display_related_items', array(
				'default'           	=> 'on',
				'sanitize_callback' 	=> 'oceanwp_sanitize_select',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Buttonset_Control( $wp_customize, 'ocean_edd_display_related_items', array(
				'label'	   				=> esc_html__( 'Display Related Items', 'oceanwp' ),
				'section'  				=> 'ocean_edd_single',
				'settings' 				=> 'ocean_edd_display_related_items',
				'priority' 				=> 10,
				'choices' 				=> array(
			 ...
			 * Related Items Count
			 */
			$wp_customize->add_setting( 'ocean_edd_related_count', array(
				'default'           	=> '3',
				'sanitize_callback' 	=> 'oceanwp_sanitize_number',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'ocean_edd_related_count', array(
				'label'	   				=> esc_html__( 'Related Items Count', 'oceanwp' ),
				'section'  				=> 'ocean_edd_single',
				'settings' 				=> 'ocean_edd_related_count',
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 1,
			        'max'   => 100,
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_related_columns', array(
				'default'           	=> '3',
				'sanitize_callback' 	=> 'oceanwp_sanitize_number',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'ocean_edd_related_columns', array(
				'label'	   				=> esc_html__( 'Related Products Columns', 'oceanwp' ),
				'section'  				=> 'ocean_edd_single',
				'settings' 				=> 'ocean_edd_related_columns',
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 1,
			        'max'   => 7,
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_floating_bar_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Heading_Control( $wp_customize, 'ocean_edd_floating_bar_heading', array(
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_display_floating_bar', array(
				'default'           	=> 'off',
				'sanitize_callback' 	=> 'oceanwp_sanitize_select',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Buttonset_Control( $wp_customize, 'ocean_edd_display_floating_bar', array(
				...
				'section'  				=> 'ocean_edd_single',
				'settings' 				=> 'ocean_edd_display_floating_bar',
				'priority' 				=> 10,
				'choices' 				=> array(
					'on' 	=> esc_html__( 'Yes', 'oceanwp' ),
					'off' 	=> esc_html__( 'No', 'oceanwp' ),
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_bg', array(
				'default'				=> '#2c2c2c',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_bg', array(
				'label'					=> esc_html__( 'Background Color', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_bg',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );

			/**
		     * Floating Bar Title Color
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_title_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_title_color', array(
				'label'					=> esc_html__( 'Title Color', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_title_color',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_price_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_price_color', array(
				'label'					=> esc_html__( 'Price Color', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_price_color',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_quantity_buttons_bg', array(
				'default'				=> 'rgba(255,255,255,0.1)',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_quantity_buttons_bg', array(
				'label'					=> esc_html__( 'Quantity Buttons: Background', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_quantity_buttons_bg',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_quantity_buttons_hover_bg', array(
				'default'				=> 'rgba(255,255,255,0.2)',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_quantity_buttons_hover_bg', array(
				'label'					=> esc_html__( 'Quantity Buttons Hover: Background', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_quantity_buttons_hover_bg',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_quantity_buttons_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_quantity_buttons_color', array(
				'label'					=> esc_html__( 'Quantity Buttons: Color', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_quantity_buttons_color',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_quantity_buttons_hover_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_quantity_buttons_hover_color', array(
				'label'					=> esc_html__( 'Quantity Buttons Hover: Color', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_quantity_buttons_hover_color',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_quantity_input_bg', array(
				'default'				=> 'rgba(255,255,255,0.2)',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_quantity_input_bg', array(
				'label'					=> esc_html__( 'Quantity Input: Background', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_quantity_input_bg',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
		     ...
		     * Floating Bar Quantity Input Color
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_quantity_input_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_quantity_input_color', array(
				'label'					=> esc_html__( 'Quantity Input: Color', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_quantity_input_color',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_addtocart_bg', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_addtocart_bg', array(
				'label'					=> esc_html__( 'Add To Cart: Background', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_addtocart_bg',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_addtocart_hover_bg', array(
				'default'				=> '#f1f1f1',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_addtocart_hover_bg', array(
				'label'					=> esc_html__( 'Add To Cart Hover: Background', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_addtocart_hover_bg',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_addtocart_color', array(
				'default'				=> '#000000',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_addtocart_color', array(
				'label'					=> esc_html__( 'Add To Cart: Color', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_addtocart_color',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_floating_bar_addtocart_hover_color', array(
				'default'				=> '#000000',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_floating_bar_addtocart_hover_color', array(
				'label'					=> esc_html__( 'Add To Cart Hover: Color', 'oceanwp' ),
				'section'				=> 'ocean_edd_single',
				'settings'				=> 'ocean_edd_floating_bar_addtocart_hover_color',
				'priority'				=> 10,
				'active_callback' 		=> 'oceanwp_cac_has_edd_floating_bar',
			) ) );
			 ...
			 * Section
			 */
			$wp_customize->add_section( 'ocean_edd_cart_checkout' , array(
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_distraction_free_cart', array(
				'default'           	=> false,
				'sanitize_callback' 	=> 'oceanwp_sanitize_checkbox',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ocean_edd_distraction_free_cart', array(
				'label'	   				=> esc_html__( 'Distraction Free Cart', 'oceanwp' ),
				'type' 					=> 'checkbox',
				'section'  				=> 'ocean_edd_cart_checkout',
				'settings' 				=> 'ocean_edd_distraction_free_cart',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Cross-Sells Count
			 */
			$wp_customize->add_setting( 'ocean_edd_cross_sells_count', array(
				'default'           	=> '2',
				'sanitize_callback' 	=> 'oceanwp_sanitize_number',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'ocean_edd_cross_sells_count', array(
				'label'	   				=> esc_html__( 'Cart: Cross-Sells Count', 'oceanwp' ),
				'section'  				=> 'ocean_edd_cart_checkout',
				'settings' 				=> 'ocean_edd_cross_sells_count',
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 1,
			        'max'   => 10,
			 ...
			 * Cross-Sells Columns
			 */
			$wp_customize->add_setting( 'ocean_edd_cross_sells_columns', array(
				'default'           	=> '2',
				'sanitize_callback' 	=> 'oceanwp_sanitize_number',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Range_Control( $wp_customize, 'ocean_edd_cross_sells_columns', array(
				'label'	   				=> esc_html__( 'Cart: Cross-Sells Columns', 'oceanwp' ),
				'section'  				=> 'ocean_edd_cart_checkout',
				'settings' 				=> 'ocean_edd_cross_sells_columns',
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 1,
			        'max'   => 7,
			 ...
			 */
			$wp_customize->add_setting( 'ocean_edd_off_canvas_sidebar_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Heading_Control( $wp_customize, 'ocean_edd_off_canvas_sidebar_heading', array(
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_off_canvas_sidebar_bg', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_off_canvas_sidebar_bg', array(
				'label'					=> esc_html__( 'Background Color', 'oceanwp' ),
				'section'				=> 'ocean_edd_styling',
				'settings'				=> 'ocean_edd_off_canvas_sidebar_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'ocean_edd_off_canvas_sidebar_widgets_border', array(
				'default'				=> 'rgba(84,84,84,0.15)',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'oceanwp_sanitize_color',
			) );

			$wp_customize->add_control( new OceanWP_Customizer_Color_Control( $wp_customize, 'ocean_edd_off_canvas_sidebar_widgets_border', array(
				'label'					=> esc_html__( 'Widgets Border Color', 'oceanwp' ),
				'section'				=> 'ocean_edd_styling',
				'settings'				=> 'ocean_edd_off_canvas_sidebar_widgets_border',
				'priority'				=> 10,
			) ) );
		...
		public static function head_css( $output ) {
			...
			$cart_dropdown_link_color 							= get_theme_mod( 'ocean_edd_cart_dropdown_link_color', '#333333' );
			$cart_dropdown_link_color_hover 					= get_theme_mod( 'ocean_edd_cart_dropdown_link_color_hover', '#13aff0' );
			...
			$cart_dropdown_quantity_color						= get_theme_mod( 'ocean_edd_cart_dropdown_quantity_color', '#b2b2b2' );
			...
			$cart_dropdown_cart_button_bg						= get_theme_mod( 'ocean_edd_cart_dropdown_cart_button_bg' );
			$cart_dropdown_cart_button_hover_bg					= get_theme_mod( 'ocean_edd_cart_dropdown_cart_button_hover_bg' );
			$cart_dropdown_cart_button_color					= get_theme_mod( 'ocean_edd_cart_dropdown_cart_button_color' );
			$cart_dropdown_cart_button_hover_color				= get_theme_mod( 'ocean_edd_cart_dropdown_cart_button_hover_color' );
			$cart_dropdown_cart_button_border_color				= get_theme_mod( 'ocean_edd_cart_dropdown_cart_button_border_color' );
			$cart_dropdown_cart_button_hover_border_color		= get_theme_mod( 'ocean_edd_cart_dropdown_cart_button_hover_border_color' );
			...
			$off_canvas_sidebar_bg 								= get_theme_mod( 'ocean_edd_off_canvas_sidebar_bg', '#ffffff' );
			$off_canvas_sidebar_widgets_border 					= get_theme_mod( 'ocean_edd_off_canvas_sidebar_widgets_border', 'rgba(84,84,84,0.15)' );
			...
			$archives_layout 									= get_theme_mod( 'ocean_edd_shop_layout', 'left-sidebar' );
			$bs_archives_content_width 							= get_theme_mod( 'ocean_edd_shop_both_sidebars_content_width' );
			$bs_archives_sidebars_width 						= get_theme_mod( 'ocean_edd_shop_both_sidebars_sidebars_width' );
			...
			if ( ! empty( $edd_menu_bag_icon_color ) && '#333333' != $edd_menu_bag_icon_color ) {
				$css .= '.wcmenucart-cart-icon .wcmenucart-count{border-color:'. $edd_menu_bag_icon_color .';}';
				$css .= '.wcmenucart-cart-icon .wcmenucart-count:after{border-color:'. $edd_menu_bag_icon_color .';}';
			}

			// Bag icon style hover color
			if ( ! empty( $edd_menu_bag_icon_hover_color ) && '#13aff0' != $edd_menu_bag_icon_hover_color ) {
				$css .= '.bag-style:hover .wcmenucart-cart-icon .wcmenucart-count, .show-cart .wcmenucart-cart-icon .wcmenucart-count{background-color:'. $edd_menu_bag_icon_hover_color .'; border-color:'. $edd_menu_bag_icon_hover_color .';}';
				$css .= '.bag-style:hover .wcmenucart-cart-icon .wcmenucart-count:after, .show-cart .wcmenucart-cart-icon .wcmenucart-count:after{border-color:'. $edd_menu_bag_icon_hover_color .';}';
			}

			// Bag icon style count color
			if ( ! empty( $edd_menu_bag_icon_count_color ) && '#333333' != $edd_menu_bag_icon_count_color ) {
				$css .= '.wcmenucart-cart-icon .wcmenucart-count, .edd-menu-icon .wcmenucart-total span{color:'. $edd_menu_bag_icon_count_color .';}';
			}

			// Bag icon style hover count color
			if ( ! empty( $edd_menu_bag_icon_hover_count_color ) && '#ffffff' != $edd_menu_bag_icon_hover_count_color ) {
				$css .= '.bag-style:hover .wcmenucart-cart-icon .wcmenucart-count, .show-cart .wcmenucart-cart-icon .wcmenucart-count{color:'. $edd_menu_bag_icon_hover_count_color .';}';
			}
			...
			if ( ! empty( $cart_dropdown_borders ) && '#e6e6e6' != $cart_dropdown_borders ) {
				$css .= '.widget_shopping_cart ul.cart_list li .owp-grid-wrap .owp-grid.thumbnail, .widget_shopping_cart ul.cart_list li, .edd ul.product_list_widget li:first-child, .widget_shopping_cart .total{border-color:'. $cart_dropdown_borders .';}';
			}
			...
			if ( ! empty( $onsale_bg ) && '#3FC387' != $onsale_bg ) {
				$css .= '.edd span.onsale{background-color:'. $onsale_bg .';}';
			}

			// Add onsale color
			if ( ! empty( $onsale_color ) && '#ffffff' != $onsale_color ) {
				$css .= '.edd span.onsale{color:'. $onsale_color .';}';
			}

			// Add out of stock bg
			if ( ! empty( $outofstock_bg ) && '#000000' != $outofstock_bg ) {
				$css .= '.edd ul.products li.product.outofstock .outofstock-badge{background-color:'. $outofstock_bg .';}';
			}

			// Add out of stock color
			if ( ! empty( $outofstock_color ) && '#ffffff' != $outofstock_color ) {
				$css .= '.edd ul.products li.product.outofstock .outofstock-badge{color:'. $outofstock_color .';}';
			}

			// Add stars color before
			if ( ! empty( $stars_color_before ) && '#dfdbdf' != $stars_color_before ) {
				$css .= '.edd .star-rating:before{color:'. $stars_color_before .';}';
			}

			// Add stars color
			if ( ! empty( $stars_color ) && '#f9ca63' != $stars_color ) {
				$css .= '.edd .star-rating span{color:'. $stars_color .';}';
			}
			...
			if ( isset( $product_top_padding ) && '' != $product_top_padding
				...
				$css .= '.edd .products .product-inner{padding:'. oceanwp_spacing_css( $product_top_padding, $product_right_padding, $product_bottom_padding, $product_left_padding ) .'}';
			}
			...
			if ( isset( $tablet_product_top_padding ) && '' != $tablet_product_top_padding
				...
				$css .= '@media (max-width: 768px){.edd .products .product-inner{padding:'. oceanwp_spacing_css( $tablet_product_top_padding, $tablet_product_right_padding, $tablet_product_bottom_padding, $tablet_product_left_padding ) .'}}';
			}
			...
			if ( isset( $mobile_product_top_padding ) && '' != $mobile_product_top_padding
				...
				$css .= '@media (max-width: 480px){.edd .products .product-inner{padding:'. oceanwp_spacing_css( $mobile_product_top_padding, $mobile_product_right_padding, $mobile_product_bottom_padding, $mobile_product_left_padding ) .'}}';
			}
			...
			if ( isset( $product_image_top_margin ) && '' != $product_image_top_margin
				...
				$css .= '.edd ul.products li.product .edd-entry-inner li.image-wrap{margin:'. oceanwp_spacing_css( $product_image_top_margin, $product_image_right_margin, $product_image_bottom_margin, $product_image_left_margin ) .'}';
			}
			...
			if ( isset( $tablet_product_image_top_margin ) && '' != $tablet_product_image_top_margin
				...
				$css .= '@media (max-width: 768px){.edd ul.products li.product .edd-entry-inner li.image-wrap{margin:'. oceanwp_spacing_css( $tablet_product_image_top_margin, $tablet_product_image_right_margin, $tablet_product_image_bottom_margin, $tablet_product_image_left_margin ) .'}}';
			}
			...
			if ( isset( $mobile_product_image_top_margin ) && '' != $mobile_product_image_top_margin
				...
				$css .= '@media (max-width: 480px){.edd ul.products li.product .edd-entry-inner li.image-wrap{margin:'. oceanwp_spacing_css( $mobile_product_image_top_margin, $mobile_product_image_right_margin, $mobile_product_image_bottom_margin, $mobile_product_image_left_margin ) .'}}';
			}
			...
			if ( isset( $product_top_border_width ) && '' != $product_top_border_width
				...
				$css .= '.edd .products .product-inner{border-style: solid}';
			}
			...
			if ( isset( $product_top_border_width ) && '' != $product_top_border_width
				...
				|| isset( $product_bottom_border_width ) && '' != $product_bottom_border_width
				|| isset( $product_left_border_width ) && '' != $product_left_border_width ) {
				$css .= '.edd .products .product-inner{border-width:'. oceanwp_spacing_css( $product_top_border_width, $product_right_border_width, $product_bottom_border_width, $product_left_border_width ) .'}';
			}
			...
			if ( isset( $tablet_product_top_border_width ) && '' != $tablet_product_top_border_width
				...
				|| isset( $tablet_product_bottom_border_width ) && '' != $tablet_product_bottom_border_width
				|| isset( $tablet_product_left_border_width ) && '' != $tablet_product_left_border_width ) {
				$css .= '@media (max-width: 768px){.edd .products .product-inner{border-width:'. oceanwp_spacing_css( $tablet_product_top_border_width, $tablet_product_right_border_width, $tablet_product_bottom_border_width, $tablet_product_left_border_width ) .'}}';
			}
			...
			if ( isset( $mobile_product_top_border_width ) && '' != $mobile_product_top_border_width
				...
				|| isset( $mobile_product_bottom_border_width ) && '' != $mobile_product_bottom_border_width
				|| isset( $mobile_product_left_border_width ) && '' != $mobile_product_left_border_width ) {
				$css .= '@media (max-width: 480px){.edd .products .product-inner{border-width:'. oceanwp_spacing_css( $mobile_product_top_border_width, $mobile_product_right_border_width, $mobile_product_bottom_border_width, $mobile_product_left_border_width ) .'}}';
			}
			...
			if ( isset( $product_top_border_radius ) && '' != $product_top_border_radius
				...
				$css .= '.edd .products .product-inner{border-radius:'. oceanwp_spacing_css( $product_top_border_radius, $product_right_border_radius, $product_bottom_border_radius, $product_left_border_radius ) .'}';
			}
			...
			if ( isset( $tablet_product_top_border_radius ) && '' != $tablet_product_top_border_radius
				...
				$css .= '@media (max-width: 768px){.edd .products .product-inner{border-radius:'. oceanwp_spacing_css( $tablet_product_top_border_radius, $tablet_product_right_border_radius, $tablet_product_bottom_border_radius, $tablet_product_left_border_radius ) .'}}';
			}
			...
			if ( isset( $mobile_product_top_border_radius ) && '' != $mobile_product_top_border_radius
				...
				$css .= '@media (max-width: 480px){.edd .products .product-inner{border-radius:'. oceanwp_spacing_css( $mobile_product_top_border_radius, $mobile_product_right_border_radius, $mobile_product_bottom_border_radius, $mobile_product_left_border_radius ) .'}}';
			}

			// Add background color
			if ( ! empty( $product_background_color ) ) {
				$css .= '.edd .products .product-inner{background-color:'. $product_background_color .';}';
			}

			// Add border color
			if ( ! empty( $product_border_color ) ) {
				$css .= '.edd .products .product-inner{border-color:'. $product_border_color .';}';
			}

			// Add category color
			if ( ! empty( $category_color ) && '#999999' != $category_color ) {
				$css .= '.edd ul.products li.product .category a{color:'. $category_color .';}';
			}

			// Add category color hover
			if ( ! empty( $category_color_hover ) && '#13aff0' != $category_color_hover ) {
				$css .= '.edd ul.products li.product .category a:hover{color:'. $category_color_hover .';}';
			}

			// Add product entry title color
			if ( ! empty( $product_title_color ) && '#333333' != $product_title_color ) {
				$css .= '.edd ul.products li.product li.title a{color:'. $product_title_color .';}';
			}

			// Add product entry title color hover
			if ( ! empty( $product_title_color_hover ) && '#13aff0' != $product_title_color_hover ) {
				$css .= '.edd ul.products li.product li.title a:hover{color:'. $product_title_color_hover .';}';
			}

			// Add product entry price color
			if ( ! empty( $product_entry_price_color ) && '#57bf6d' != $product_entry_price_color ) {
				$css .= '.edd ul.products li.product .price, .edd ul.products li.product .price .amount{color:'. $product_entry_price_color .';}';
			}

			// Add product entry del price color
			if ( ! empty( $product_entry_del_price_color ) && '#666666' != $product_entry_del_price_color ) {
				$css .= '.edd ul.products li.product .price del .amount{color:'. $product_entry_del_price_color .';}';
			}

			// Add product entry add to cart background color
			if ( ! empty( $product_entry_addtocart_bg_color ) ) {
				$css .= '.edd ul.products li.product .button,.edd ul.products li.product .product-inner .added_to_cart{background-color:'. $product_entry_addtocart_bg_color .';}';
			}

			// Add product entry add to cart background color hover
			if ( ! empty( $product_entry_addtocart_bg_color_hover ) ) {
				$css .= '.edd ul.products li.product .button:hover,.edd ul.products li.product .product-inner .added_to_cart:hover{background-color:'. $product_entry_addtocart_bg_color_hover .';}';
			}

			// Add product entry add to cart color
			if ( ! empty( $product_entry_addtocart_color ) && '#848494' != $product_entry_addtocart_color ) {
				$css .= '.edd ul.products li.product .button,.edd ul.products li.product .product-inner .added_to_cart{color:'. $product_entry_addtocart_color .';}';
			}
			...
			if ( ! empty( $product_entry_addtocart_color_hover ) && '#13aff0' != $product_entry_addtocart_color_hover ) {
				$css .= '.edd ul.products li.product .button:hover,.edd ul.products li.product .product-inner .added_to_cart:hover{color:'. $product_entry_addtocart_color_hover .';}';
			}
			...
			if ( ! empty( $product_entry_addtocart_border_color ) && '#e4e4e4' != $product_entry_addtocart_border_color ) {
				$css .= '.edd ul.products li.product .button,.edd ul.products li.product .product-inner .added_to_cart{border-color:'. $product_entry_addtocart_border_color .';}';
			}
			...
			if ( ! empty( $product_entry_addtocart_border_color_hover ) && '#13aff0' != $product_entry_addtocart_border_color_hover ) {
				$css .= '.edd ul.products li.product .button:hover,.edd ul.products li.product .product-inner .added_to_cart:hover{border-color:'. $product_entry_addtocart_border_color_hover .';}';
			}
			...
			if ( ! empty( $product_entry_addtocart_border_style ) && 'double' != $product_entry_addtocart_border_style ) {
				$css .= '.edd ul.products li.product .button,.edd ul.products li.product .product-inner .added_to_cart{border-style:'. $product_entry_addtocart_border_style .';}';
			}
			...
			if ( ! empty( $product_entry_addtocart_border_size ) && '3' != $product_entry_addtocart_border_size ) {
				$css .= '.edd ul.products li.product .button,.edd ul.products li.product .product-inner .added_to_cart{border-width:'. $product_entry_addtocart_border_size .';}';
			}

			// Add product entry add to cart border radius
			if ( ! empty( $product_entry_addtocart_border_radius ) ) {
				$css .= '.edd ul.products li.product .button,.edd ul.products li.product .product-inner .added_to_cart{border-radius:'. $product_entry_addtocart_border_radius .';}';
			}
			...
			if ( ! empty( $single_product_title_color ) && '#333333' != $single_product_title_color ) {
				$css .= '.edd div.product .product_title{color:'. $single_product_title_color .';}';
			}
			...
			if ( ! empty( $single_product_description_color ) && '#aaaaaa' != $single_product_description_color ) {
				$css .= '.edd div.product div[itemprop="description"]{color:'. $single_product_description_color .';}';
			}
