	...
	class OceanWP_General_Customizer {
		...
		public function head_css( $output ) {
			...
			if ( ! empty( $background_color ) && '#ffffff' != $background_color ) {
				$css .= 'body, .has-parallax-footer #main{background-color:'. $background_color .';}';
			}
