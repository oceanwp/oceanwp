		...
		'options'  => [
			...
			'ocean_single_additional_layout_section' => [
				...
				'options'  => [
					'ocean_desc_for_blog_single_additional_layout_settings' => [
						'type'      => 'ocean-content',
						'isContent' => esc_html__( 'Additional layout settings are currently available for Both Sidebars and Full Width layout styles.', 'oceanwp' ),
			...
			'ocean_blog_single_title_options_section' => [
				...
				'options'  => [
					...
					'ocean_blog_single_title_bg_image_typo_and_colors' => [
						'type' => 'ocean-title',
						'label' => esc_html__( 'Typography and Colors', 'oceanwp' ),
						'section' => 'ocean_blog_single_title_options_section',
						'transport' => 'postMessage',
					...
					'ocean_blog_single_title_bg_image_breadcrumb_typography' => [
						...
						'type' => 'ocean-typography',
						'label' => esc_html__('Page Title Breadcrumb', 'oceanwp'),
						'section' => 'ocean_blog_single_title_options_section',
						'transport' => 'postMessage',
						'priority' => 10,
						'hideLabel' => false,
					...
					'ocean_divider_after_blog_single_title_bg_image_breadcrumb_typography' => [
						'type' => 'ocean-divider',
						'section' => 'ocean_blog_single_title_options_section',
						'transport' => 'postMessage',
						'priority' => 10,
