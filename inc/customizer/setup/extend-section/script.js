...
(function ($) {
    ...
    addIconToCustomizerSection('ocean_typography', typoIcon);
	addIconToCustomizerSection('ocean_colors', colorIcon);
	addIconToCustomizerSection('ocean_styles_and_settings', siteSettingIcon);
	addIconToCustomizerSection('ocean_site_page_settings', pageSettingIcon);
	addIconToCustomizerSection('ocean_topbar_settings', topbarIcon);
	addIconToCustomizerSection('ocean_header_settings', headerIcon);
	addIconToCustomizerSection('ocean_blog_settings', blogIcon);
