...
$options = [
    ...
    'ocean_header_general_section' => [
		...
		'options' => [
            ...
            'ocean_spacer_after_header_style_setting' => [
                'type' => 'ocean-spacer',
                'section' => 'ocean_header_general_section',
                'transport' => 'postMessage',
                'priority' => 10,
            ...
            'ocean_custom_header_section' => [
                ...
                'section'  => 'ocean_header_general_section',
                'after'    => 'ocean_spacer_after_header_style_setting',
                'class'    => 'section-site-layout',
                'priority' => 10,
                'options'  => [
                    'ocean_desc_for_custom_header_settings' => [
                        'type'      => 'ocean-content',
                        'isContent' => esc_html__( 'Additional settings for the Custom Header type will appear here.', 'oceanwp' ),
                    ...
                    'ocean_header_template' => [
                        ...
                        'desc'              => esc_html__( 'You can replace the default website header entirely with a custom template created in OceanWP > My Library.', 'oceanwp' ),
                        'section'           => 'ocean_custom_header_section',
                        'transport'         => 'refresh',
                        'default'           => '0',
                        'priority'          => 10,
            ...
            'ocean_divider_after_custom_header_setting_section' => [
                'type'      => 'ocean-divider',
                'section'   => 'ocean_header_general_section',
                'transport' => 'postMessage',
                'priority'  => 10,
            ...
            'ocean_header_styling_section' => [
                'type' => 'section',
                'title' => esc_html__( 'Styling', 'oceanwp' ),
                'section' => 'ocean_header_general_section',
                'after' => 'ocean_divider_after_custom_header_setting_section',
                'class' => 'section-site-layout',
                'priority' => 10,
                'options' => [
                    'ocean_header_height' => [
                        ...
                        'section'           => 'ocean_header_styling_section',
                        'transport'         => 'postMessage',
                        'priority'          => 10,
                        'hideLabel'         => false,
                        'isUnit'            => true,
            ...
            'ocean_spacer_after_header_style_section' => [
                'type' => 'ocean-spacer',
                'section' => 'ocean_header_general_section',
                'transport' => 'postMessage',
                'priority' => 10,
            ...
            'ocean_header_additional_styling_section' => [
                ...
                'section' => 'ocean_header_general_section',
                'after' => 'ocean_spacer_after_header_style_section',
                'class' => 'section-site-layout',
                'priority' => 10,
                'options' => [
                    'ocean_desc_for_additional_styling_settings' => [
                        'type'      => 'ocean-content',
                        'isContent' => esc_html__( 'Additional customization options available for the Top Menu, Full Screen, Center, and Medium header types will display here.', 'oceanwp' ),
                    ...
                    'ocean_spacer_after_custom_vertical_header_section' => [
                        'type' => 'ocean-spacer',
                        'section' => 'ocean_header_additional_styling_section',
                        'transport' => 'postMessage',
                        'priority' => 50,
            ...
            'ocean_header_content_section' => [
                ...
                'options' => [
                    'ocean_desc_for_header_content_settings' => [
                        'type' => 'ocean-content',
                        'isContent' => esc_html__('If the Header Type you selected supports additional content for the After Header hook, the option to add content will appear here. The Content option is supported by the Minimal and Transparent Header types.', 'oceanwp'),
            ...
            'ocean_spacer_after_header_content_section' => [
                'type' => 'ocean-spacer',
                'section' => 'ocean_header_general_section',
                'transport' => 'postMessage',
                'priority' => 10,
    ...
    'ocean_header_menu_section' => [
		...
		'options' => [
            ...
            'ocean_divider_after_menu_links_effect_settings' => [
                'type' => 'ocean-divider',
                'section' => 'ocean_header_menu_section',
                'transport' => 'postMessage',
                'top' => 10,
            ...
            'ocean_header_custom_menu_section' => [
                ...
                'section' => 'ocean_header_menu_section',
                'after' => 'ocean_divider_after_menu_links_effect_settings',
                'class' => 'section-site-layout',
                'priority' => 10,
                'options' => [
                    'ocean_desc_for_header_custom_menu_settings' => [
                        'type' => 'ocean-content',
                        'isContent' => esc_html__('Select a custom template you created in OceanWP > My Library that will replace the default menu navigation only. If you want to create an entire custom header, it\'s best you select the Custom Header type in Customize > Header > General.', 'oceanwp'),
            ...
            'ocean_divider_after_custom_menu_section' => [
                'type' => 'ocean-divider',
                'section' => 'ocean_header_menu_section',
                'transport' => 'postMessage',
                'priority' => 10,
            ...
            'ocean_header_main_menu_options_section' => [
                'type' => 'section',
                'title' => esc_html__('Main Menu Options', 'oceanwp'),
                'section' => 'ocean_header_menu_section',
                'after' => 'ocean_divider_after_custom_menu_section',
                'class' => 'section-site-layout',
                'priority' => 10,
                'options' => [
                    ...
                    'ocean_divider_after_menu_spacing_setting' => [
                        'type' => 'ocean-divider',
                        'section' => 'ocean_header_menu_section',
                        'transport' => 'postMessage',
                        'priority' => 10,
                    ...
                    'ocean_menu_link_background' => [
                        ...
                        'setting_args' => [
                            'normal' => [
                                ...
                                'label' => 'Normal',
                                'selector' => [
                                    '#site-navigation-wrap .dropdown-menu > li > a' => 'background-color'
                                ],
                                'attr' => [
                                    'transport' => 'postMessage',
                                ],
                            ...
                            'hover' => [
                                ...
                                'label' => 'Hover',
                                'selector' => [
                                    '#site-navigation-wrap .dropdown-menu > li > a:hover,#site-navigation-wrap .dropdown-menu > li.sfHover > a' => 'background-color'
                                ],
                                'attr' => [
                                    'transport' => 'postMessage',
                                    'default'   => '#f8f8f8',
                    ...
                    'ocean_menu_link_color' => [
                        ...
                        'setting_args' => [
                            'normal' => [
                                ...
                                'label' => 'Normal',
                                'selector' => [
                                    '#site-navigation-wrap .dropdown-menu > li > a,.oceanwp-mobile-menu-icon a,#searchform-header-replace-close' => 'color',
                                    '#site-navigation-wrap .dropdown-menu > li > a .owp-icon use,.oceanwp-mobile-menu-icon a .owp-icon use,#searchform-header-replace-close .owp-icon use' => 'stroke'
                                ],
                                'attr' => [
                                    'transport' => 'postMessage',
                                    'default'   => '#555555',
                            ...
                            'hover' => [
                                ...
                                'label' => 'Hover',
                                'selector' => [
                                    '#site-navigation-wrap .dropdown-menu > li > a:hover,.oceanwp-mobile-menu-icon a:hover,#searchform-header-replace-close:hover' => 'color',
                                    '#site-navigation-wrap .dropdown-menu > li > a:hover .owp-icon use,.oceanwp-mobile-menu-icon a:hover .owp-icon use,#searchform-header-replace-close:hover .owp-icon use' => 'stroke'
                                ],
                                'attr' => [
                                    'transport' => 'postMessage',
                                    'default'   => '#13aff0',
                    ...
                    'ocean_menu_link_color_active' => [
                        ...
                        'setting_args' => [
                            'normal' => [
                                ...
                                'label' => 'Select Color',
                                'selector' => [
                                    '#site-navigation-wrap .dropdown-menu > .current-menu-item > a,#site-navigation-wrap .dropdown-menu > .current-menu-ancestor > a,#site-navigation-wrap .dropdown-menu > .current-menu-item > a:hover,#site-navigation-wrap .dropdown-menu > .current-menu-ancestor > a:hover' => 'color'
                                ],
                                'attr' => [
                                    'transport' => 'postMessage',
                                    'default'   => '#555555',
                    ...
                    'ocean_menu_link_active_background' => [
                        ...
                        'setting_args' => [
                            'normal' => [
                                ...
                                'label' => 'Select Color',
                                'selector' => [
                                    '#site-navigation-wrap .dropdown-menu > .current-menu-item > a,#site-navigation-wrap .dropdown-menu > .current-menu-ancestor > a,#site-navigation-wrap .dropdown-menu > .current-menu-item > a:hover,#site-navigation-wrap .dropdown-menu > .current-menu-ancestor > a:hover' => 'background-color'
                                ],
                                'attr' => [
                                    'transport' => 'postMessage',
                                ],
            ...
            'ocean_divider_after_main_menu_options_section' => [
                'type' => 'ocean-divider',
                'section' => 'ocean_header_menu_section',
                'transport' => 'postMessage',
                'priority' => 10,
            ...
            'ocean_header_dropdown_menu_options_section' => [
                ...
                'section' => 'ocean_header_menu_section',
                'after' => 'ocean_divider_after_main_menu_options_section',
                'class' => 'section-site-layout',
                'priority' => 10,
                'options' => [
                    ...
                    'ocean_divider_after_menu_dropdown_panel_width_setting' => [
                        'type' => 'ocean-divider',
                        'section' => 'ocean_header_dropdown_menu_options_section',
                        'transport' => 'postMessage',
                        'priority' => 10,
                    ...
                    'ocean_header_dropdown_post_categories_section' => [
                        'type' => 'section',
                        'title' => esc_html__('Post Categories Dropdown', 'oceanwp'),
                        'section' => 'ocean_header_dropdown_menu_options_section',
                        'after' => 'ocean_divider_after_menu_dropdown_panel_width_setting',
                        'class' => 'section-site-layout',
                        'priority' => 10,
                        'options' => [
                            'ocean_dropdown_category_title_bg' => [
                                ...
                                'section' => 'ocean_header_dropdown_post_categories_section',
                                'transport' => 'postMessage',
                                'priority' => 10,
                                'hideLabel' => false,
                                'showAlpha' => true,
                    ...
                    'ocean_divider_after_menu_dropdown_post_categories_setting' => [
                        'type' => 'ocean-divider',
                        'section' => 'ocean_header_dropdown_menu_options_section',
                        'transport' => 'postMessage',
                        'priority' => 10,
    ...
    'ocean_header_social_menu_section' => [
		...
		'options' => [
            ...
            'ocean_divider_after_header_menu_social_setting' => [
                'type' => 'ocean-divider',
                'section' => 'ocean_header_social_menu_section',
                'transport' => 'postMessage',
                'priority' => 10,
            ...
            'ocean_header_social_menu_default_section' => [
                ...
                'section' => 'ocean_header_social_menu_section',
                'after' => 'ocean_divider_after_header_menu_social_setting',
                'class' => 'section-site-layout',
                'priority' => 10,
                'options' => [
                    'ocean_menu_social_target' => [
                        ...
                        'section' => 'ocean_header_social_menu_default_section',
                        'default'  => 'blank',
                        'transport' => 'postMessage',
                        'priority' => 10,
                        'hideLabel' => false,
                    ...
                    'ocean_spacer_after_header_default_social_icon_setting_section' => [
                        'type' => 'ocean-spacer',
                        'section' => 'ocean_header_default_social_icon_setting_section',
                        'transport' => 'postMessage',
                        'priority' => 10,
                    ...
                    'ocean_header_default_social_icon_colors_section' => [
                        'type' => 'section',
                        'title' => esc_html__('Social Icons Colors', 'oceanwp'),
                        'section' => 'ocean_header_default_social_icon_setting_section',
                        'after' => 'ocean_spacer_after_header_default_social_icon_setting_section',
                        'class' => 'section-site-layout',
                        'priority' => 10,
                        'options' => [
                            'ocean_desc_for_default_social_icon_colors_settings' => [
                                'type' => 'ocean-content',
                                'isContent' => esc_html__('Color options are available for the Simple Social Icons Style.', 'oceanwp'),
                                'section' => 'ocean_header_default_social_icon_colors_section',
                                'class' => 'description',
                                'transport' => 'postMessage',
                                'priority' => 10,
                                'active_callback' => 'ocean_cac_header_social_menu',
                            ...
                            'ocean_menu_social_links_color' => [
                                'type' => 'ocean-color',
                                'label' => esc_html__( 'Icons color', 'oceanwp' ),
                                'section' => 'ocean_header_default_social_icon_colors_section',
                                'transport' => 'postMessage',
                                'priority' => 10,
                                'hideLabel' => false,
            ...
            'ocean_spacer_for_social_menu_custom_template_section' => [
                'type' => 'ocean-spacer',
                'section' => 'ocean_header_social_menu_section',
                'transport' => 'postMessage',
                'priority' => 10,
            ...
            'ocean_header_social_menu_links_section' => [
                ...
                'section' => 'ocean_header_social_menu_section',
                'after' => 'ocean_spacer_for_social_menu_custom_template_section',
                'class' => 'section-site-layout',
                'priority' => 10,
                'options' => [
            ...
            'ocean_divider_after_default_social_menu_options_section' => [
                'type' => 'ocean-divider',
                'section' => 'ocean_header_social_menu_section',
                'transport' => 'postMessage',
                'priority' => 10,
            ...
            'ocean_header_social_menu_custom_template_section' => [
                ...
                'section' => 'ocean_header_social_menu_section',
                'after' => 'ocean_divider_after_default_social_menu_options_section',
                'class' => 'section-site-layout',
                'priority' => 10,
                'options' => [
                    'ocean_desc_for_social_menu_custom_template_settings' => [
                        'type' => 'ocean-content',
                        'isContent' => esc_html__('Select a template you created in OceanWP > My Library to replace the default Social Icons.', 'oceanwp'),
    ...
    'ocean_header_mobile_menu_section' => [
		...
		'options' => [
            'ocean_mobile_menu_breakpoints' => [
                ...
                'desc' => esc_html__('Choose the media query width at which point your website will start displaying the mobile menu.', 'oceanwp' ),
            ...
            'ocean_mobile_menu_style' => [
                ...
                'choices' => [
                    'sidebar' => [
                        ...
                        'default' => oceanwp_customizer_print_svg('mobile_menu_style_sidebar-default'),
						'active'  => oceanwp_customizer_print_svg('mobile_menu_style_sidebar-active'),
                    ],
                    'dropdown'  => [
                        'label'   => esc_html__( 'Dropdown', 'oceanwp' ),
                        'default' => oceanwp_customizer_print_svg('mobile_menu_style_dropdown-default'),
						'active'  => oceanwp_customizer_print_svg('mobile_menu_style_dropdown-active'),
                    ],
                    'fullscreen'  => [
                        'label'   => esc_html__( 'Full Screen', 'oceanwp' ),
                        'default' => oceanwp_customizer_print_svg('mobile_menu_style_fullscreen-default'),
						'active'  => oceanwp_customizer_print_svg('mobile_menu_style_fullscreen-active'),
                    ]
                ]
            ],
            ...
            'ocean_divider_after_mobile_menu_search_type_setting' => [
                'type' => 'ocean-divider',
                'section' => 'ocean_header_mobile_menu_section',
                'transport' => 'postMessage',
                'priority' => 10,
            ...
            'ocean_header_mobile_menu_general_section' => [
                ...
                'section' => 'ocean_header_mobile_menu_section',
                'after' => 'ocean_divider_after_mobile_menu_search_type_setting',
                'class' => 'section-site-layout',
                'priority' => 10,
                'options' => [
                    ...
                    'ocean_divider_after_mobile_elements_positioning_setting' => [
                        'type' => 'ocean-divider',
                        'section' => 'ocean_header_mobile_menu_general_section',
                        'transport' => 'postMessage',
                        'priority' => 10,
            ...
            'ocean_spacer_after_mobile_menu_styling_section' => [
                'type' => 'ocean-spacer',
                'section' => 'ocean_header_mobile_menu_section',
                'transport' => 'postMessage',
                'priority' => 10,
