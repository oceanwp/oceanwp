		...
		'options' => [
            ...
            'ocean_blog_style' => [
                ...
                'choices' => [
                    'large-entry' => [
                        'id'     => 'large-entry',
                        'label'   => esc_html__('Large Image', 'oceanwp'),
                        'content' => esc_html__('Large Image', 'oceanwp'),
                    ],
                    'grid-entry'  => [
                        'id'     => 'grid-entry',
                    ...
                    'thumbnail-entry'  => [
                        ...
                        'content' => esc_html__('Thumbnail', 'oceanwp'),
                    ]
                ]
            ],
            ...
            'ocean_blog_single_title_options_section' => [
                ...
                'options' => [
                    ...
                    'oceanwp_blog_single_header_meta' => [
                        'label' => esc_html__( 'Post Title Meta Builder ', 'oceanwp' ),
                        'type' => 'ocean-sortable',
                        'section'  => 'ocean_blog_single_title_options_section',
                        'transport' => 'refresh',
                        'priority' => 10,
