...
$options = [
    ...
    'ocean_footer_widgets' => [
        ...
        'section' => 'ocean_footer_widget_settings',
        'default'  => true,
        'transport' => 'refresh',
        'priority' => 10,
        'hideLabel' => false
    ...
    'ocean_title_for_footer_widget_default_settings' => [
        ...
        'desc' => esc_html__('These options function only with a default WordPress Footer Widgets area but will not function with a custom template.', 'oceanwp'),
        'section' => 'ocean_footer_widget_settings',
        'transport' => 'postMessage',
        'priority' => 10,
        'active_callback' => 'ocean_cac_footer_widget',
    ...
    'ocean_title_for_footer_custom_settings' => [
        ...
        'desc' => esc_html__('Choose a custom template for your Footer Widgets area, created in OceanWP > My Library.', 'oceanwp'),
        'section' => 'ocean_footer_widget_settings',
        'transport' => 'postMessage',
        'priority' => 10,
        'active_callback' => 'ocean_cac_footer_widget',
    ...
    'ocean_fixed_footer' => [
        ...
        'desc' => esc_html__('This option adds height to your content so that the footer is always at the bottom.', 'oceanwp'),
        'section' => 'ocean_footer_widget_settings',
        'default'  => 'off',
        'transport' => 'refresh',
        'priority' => 10,
    ...
    'ocean_parallax_footer' => [
        ...
        'desc' => esc_html__('This options enables the footer parallax effect.', 'oceanwp'),
        'section' => 'ocean_footer_widget_settings',
        'default'  => 'off',
        'transport' => 'refresh',
        'priority' => 10,
