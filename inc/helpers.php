...
if ( ! function_exists( 'oceanwp_add_search_to_menu' ) ) {
	...
	function oceanwp_add_search_to_menu( $items, $args ) {
		...
		if ( 'full_screen' == $header_style ) {
			...
			$items     .= '<a href="' . esc_url( site_url() ) . '/#" class="site-search-toggle' . $class . '" aria-label="' . esc_attr( 'Search website', 'oceanwp' ) . '">';
...
if ( ! function_exists( 'oceanwp_top_header_search' ) ) {
	...
	function oceanwp_top_header_search() {
		...
		echo '<div id="search-toggle">';
			echo '<a href="' . esc_url( site_url() ) . '/#" class="site-search-toggle' . esc_attr( $class ) . '" aria-label="' . esc_attr__( 'Search website', 'oceanwp' ) . '">';
				oceanwp_icon( 'search' );
			echo '</a>';
		echo '</div>';
...
function oceanwp_mobile_search_icon() {
	...
	<a href="<?php echo esc_url( site_url() ); ?>/#" class="search-icon-<?php echo esc_attr( $class ); ?>" aria-label="<?php oceanwp_theme_strings( 'owp-string-mobile-search', 'oceanwp' ); ?>"><?php oceanwp_icon( 'search' ); ?></a>
...
function oceanwp_mobile_search_form_html() {
	...
	if ( 'drop_down' === $search_style ) {
		...
		<div class="container clr">
			<form method="get" class="mobile-searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
				<a href="<?php echo esc_url( site_url() ); ?>/#" class="search-overlay-close" aria-label="<?php oceanwp_theme_strings( 'owp-string-close-search-form' ); ?>"><span></span></a>
				<span class="screen-reader-text"><?php oceanwp_theme_strings( 'owp-string-search-form-label' ); ?></span>
