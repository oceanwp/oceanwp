...
add_action(
	...
	function () {
		...
		$theme_version     = ! empty( $parent_theme ) ? $parent_theme->get( 'Version' ) : $current_theme->get( 'Version' );
		...
		} elseif ( $first_dismissed && ! $permanent_dismiss ) {
			$actions_html = '<div class="notice-actions">';
		...
		wp_send_json_success( $actions_html );
	}
);
