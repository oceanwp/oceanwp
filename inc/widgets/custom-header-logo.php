...
if ( ! class_exists( 'OceanWP_Custom_Header_Logo_Widget' ) ) {
	class OceanWP_Custom_Header_Logo_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				...
				esc_html__( '&raquo; Custom Header Logo', 'oceanwp' ),
				array(
					'classname'   => 'widget-oceanwp-custom-header-logo custom-header-logo-widget',
					'description' => esc_html__( 'Display the logo for the Custom Header style.', 'oceanwp' ),
		...
		function form( $instance ) {
			...
			<p>
				<?php esc_html_e( 'This widget is to display with your page builder the logo for the Custom Header style.', 'oceanwp' ); ?>
			</p>
...
register_widget( 'OceanWP_Custom_Header_Logo_Widget' );