...
<a id="scroll-top" class="scroll-top-<?php echo esc_attr( $position ); ?>" href="#"><span class="<?php echo esc_attr( $arrow ); ?>" aria-label="<?php esc_html_e( 'Scroll to the top of the page', 'oceanwp' ); ?>"></span></a>
