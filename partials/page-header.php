...
<header class="<?php echo esc_attr( $classes ); ?>">
	...
	<div class="container clr page-header-inner">
		...
		if ( oceanwp_has_page_header_heading() ) {
			...
			<<?php echo esc_attr( $heading ); ?> class="page-header-title clr"<?php oceanwp_schema_attr( 'headline' ); ?>><?php echo wp_kses_post( oceanwp_has_page_title() ); ?></<?php echo esc_attr( $heading ); ?>>
