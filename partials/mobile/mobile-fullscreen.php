...
<div id="mobile-fullscreen" class="clr" <?php echo $fullscreen_menu_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	...
	<div id="mobile-fullscreen-inner" class="clr">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="close" aria-label="<?php esc_attr( oceanwp_theme_strings( 'owp-string-close-mobile-menu' ) ); ?>" <?php echo $fs_menu_close_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
