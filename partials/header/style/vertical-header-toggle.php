...
<a href="<?php esc_url( home_url( '/' ) ); ?>" class="vertical-toggle"><span class="screen-reader-text"><?php esc_html( oceanwp_theme_strings( 'owp-string-vertical-header-toggle' ) ); ?></span>
