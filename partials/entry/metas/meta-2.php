 ...
 * 
 * Template for metas without icons
 *
...
$ocean_date_onoff = apply_filters( 'ocean_meta_2_modified_date_state', $ocean_date_onoff );
...
<ul class="meta <?php echo oceanwp_theme_blog_meta_separator(); ?>">
