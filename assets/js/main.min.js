function fadeOut(e){e.style.opacity=1,function t(){(e.style.opacity-=.1)<0?e.style.display="none":requestAnimationFrame(t)}()}function fadeIn(e,t){e.style.opacity=0,e.style.display=t||"block",function t(){var i=parseFloat(e.style.opacity);(i+=.1)>=1||(e.style.opacity=i,requestAnimationFrame(t))}()}
/*!
 ...
 */
!function(e){"use strict";e.fn.extend({customSelect:function(t){if(void 0===document.body.style.maxHeight)return this;var i=(t=e.extend({customClass:"customSelect",mapClass:!0,mapStyle:!0},t)).customClass,o=function(t,i){var o=t.find(":selected"),s=i.children(":first"),r=o.html()||"&nbsp;";s.html(r),o.attr("disabled")?i.addClass(n("DisabledOption")):i.removeClass(n("DisabledOption")),setTimeout((function(){i.removeClass(n("Open")),e(document).off("mouseup.customSelect")}),60)},n=function(e){return i+e};return this.each((function(){var s=e(this),r=e("<span />").addClass(n("Inner")),a=e("<span />");s.after(a.append(r)),a.addClass(i),t.mapClass&&a.addClass(s.attr("class")),t.mapStyle&&a.attr("style",s.attr("style")),s.addClass("hasCustomSelect").on("render.customSelect",(function(){o(s,a),s.css("width","");parseInt(s.outerWidth(),10),parseInt(a.outerWidth(),10),parseInt(a.width(),10);a.css({display:"inline-block"});var e=a.outerHeight();s.attr("disabled")?a.addClass(n("Disabled")):a.removeClass(n("Disabled")),r.css({display:"inline-block"}),s.css({"-webkit-appearance":"menulist-button",width:a.outerWidth(),position:"absolute",opacity:0,height:e,fontSize:a.css("font-size")})})).on("change.customSelect",(function(){a.addClass(n("Changed")),o(s,a)})).on("keyup.customSelect",(function(e){a.hasClass(n("Open"))?13!=e.which&&27!=e.which||o(s,a):(s.trigger("blur.customSelect"),s.trigger("focus.customSelect"))})).on("mousedown.customSelect",(function(){a.removeClass(n("Changed"))})).on("mouseup.customSelect",(function(t){a.hasClass(n("Open"))||(e("."+n("Open")).not(a).length>0&&"undefined"!=typeof InstallTrigger?s.trigger("focus.customSelect"):(a.addClass(n("Open")),t.stopPropagation(),e(document).one("mouseup.customSelect",(function(t){t.target!=s.get(0)&&e.inArray(t.target,s.find("*").get())<0?s.trigger("blur.customSelect"):o(s,a)}))))})).on("focus.customSelect",(function(){a.removeClass(n("Changed")).addClass(n("Focus"))})).on("blur.customSelect",(function(){a.removeClass(n("Focus")+" "+n("Open"))})).on("mouseenter.customSelect",(function(){a.addClass(n("Hover"))})).on("mouseleave.customSelect",(function(){a.removeClass(n("Hover"))})).trigger("render.customSelect")}))}})}(jQuery);var FitVids=function(){"use strict";return function(e){var t,i={},o=function(){(t=Array.from(document.querySelectorAll(e||'iframe[src*="player.vimeo.com"], iframe[src*="youtube.com"]'))).length&&(!function(){if(!document.querySelector("#fitvids-styles")){var e=document.head||document.getElementsByTagName("head")[0],t=document.createElement("div");t.innerHTML='<p>x</p><style id="fitvids-styles">.fitvids{width:100%;position:relative;padding:0;}.fitvids iframe,.fitvids object,.fitvids embed {position:absolute;top:0;left:0;width:100%;height:100%;}</style>',e.appendChild(t.childNodes[1])}}(),t.forEach((function(e){if(!("embed"===e.tagName.toLowerCase()&&e.closest("object")||e.closest(".fitvids"))){var t=parseFloat(e.height),i=parseFloat(e.width);if(t&&i&&!isNaN(t)&&!isNaN(i)){var o=document.createElement("div");o.className="fitvids",o.style.paddingTop=t/i*100+"%",e.parentNode.insertBefore(o,e),o.appendChild(e)}}})))};return i.render=function(){o()},o(),i}}();function oceanwpCustomSelects(){"use strict";$j(oceanwpLocalize.customSelects).customSelect({customClass:"theme-select"})}
/*!
